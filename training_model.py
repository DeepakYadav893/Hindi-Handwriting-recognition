...
from keras.layers import Input,Dense,Activation,ZeroPadding2D,Dropout,BatchNormalization,Flatten,Conv2D
...
def main():
	...
	x_train=x_train.reshape(train_y.shape[0],image_x,image_y,1)
	x_test=x_test.reshape(test_y.shape[0],image_x,image_y,1)
